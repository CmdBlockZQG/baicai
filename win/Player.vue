<template>
  <video controls :src="x.videoURL" id="video"></video>
  <canvas id="canvas"></canvas>
  <div id="danmu">
    <div id="delay">
      <span>延时(ms)：</span>
      <input id="delay-input" type="number" style="width: 128px;" value="0"/>
      <button @click="setDelay">确认</button>
    </div>
...
function frame() {
  ...
  let now = video.currentTime * 1000 + x.start - delay
...
function setDelay() {
  delay = Number(document.getElementById('delay-input').value)
  console.log(delay)
}
